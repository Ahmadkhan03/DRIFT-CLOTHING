...
2. In the dashboard open **SQL Editor → New query**, paste the contents of `supabase/migrations/0001_orders.sql` and click **Run**.
...
Orders appear in Supabase → Table Editor → `orders` until the admin panel is built.
